...
public class CreateColumnFamilyStatement extends SchemaAlteringStatement
{
    ...
    public CreateColumnFamilyStatement(CFName name, CFPropDefs properties, boolean createIfNotExists)
    {
        super(name);
    ...
    public static class RawStatement extends CFStatement
    {
        ...
        public RawStatement(CFName name, boolean createIfNotExists)
        {
            super(name);
            this.createIfNotExists = createIfNotExists;
        }
        ...
        public ParsedStatement.Prepared prepare() throws RequestValidationException
        {
            ...
            CreateColumnFamilyStatement stmt = new CreateColumnFamilyStatement(cfName, properties, createIfNotExists);
